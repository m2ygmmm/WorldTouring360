...
public class australia extends AppCompatActivity {
    ...
    public ImageButton australiabtn;
    public ImageButton nzeland;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navbarmethod();
        sidebarOneMethod();
        TextView worldiconText = (TextView) findViewById(R.id.australiaText);
    ...
    public void sidebarOneMethod(){
        ...
        nzeland = (ImageButton) findViewById(R.id.nZealand);
        australiabtn = (ImageButton) findViewById(R.id.ausButton);
        returnbutton = (ImageButton) findViewById(R.id.backButton);
        returnbutton2 = (ImageButton) findViewById(R.id.backButton2);

        nzeland.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "Newzealand");
                editor.commit();
            }
        });
        australiabtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "australia");
                editor.commit();
