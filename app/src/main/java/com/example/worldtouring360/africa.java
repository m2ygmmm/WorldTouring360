...
public class africa extends AppCompatActivity {
    ...
    public ImageButton safrica;
    public ImageButton algeriabtn;
    public ImageButton egypt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navbarmethod();
        sidebarOneMethod();
        TextView worldiconText = (TextView) findViewById(R.id.africaText);
    ...
    public void sidebarOneMethod(){
        ...
        safrica = (ImageButton) findViewById(R.id.safricaButton);
        egypt = (ImageButton) findViewById(R.id.egyptButton);
        algeriabtn = (ImageButton) findViewById(R.id.algeriaButton);
        ...
        safrica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "southafrica");
                editor.commit();
            }
        });
        algeriabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "algeria");
                editor.commit();
            }
        });
        egypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "egypt");
                editor.commit();
            }
        });
