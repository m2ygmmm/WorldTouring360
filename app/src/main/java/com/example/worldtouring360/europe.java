...
public class europe extends AppCompatActivity {
    ...
    public ImageButton france;
    public ImageButton germany;
    public ImageButton england;
    public ImageButton italy;
    public ImageButton norway;
    public ImageButton spain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navbarmethod();
        sidebarOneMethod();
        TextView worldiconText = (TextView) findViewById(R.id.europeText);
    ...
    public void sidebarOneMethod(){
        ...
        france = (ImageButton) findViewById(R.id.franceButton);
        germany = (ImageButton) findViewById(R.id.germanyButton);
        england = (ImageButton) findViewById(R.id.englandButton);
        italy = (ImageButton) findViewById(R.id.italyButton);
        norway = (ImageButton) findViewById(R.id.norwayButton);
        spain = (ImageButton) findViewById(R.id.spainButton);
        ...
        france.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "france");
                editor.commit();
            }
        });
        germany.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "germany");
                editor.commit();
            }
        });
        england.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "england");
                editor.commit();
            }
        });
        italy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "italy");
                editor.commit();
            }
        });
        norway.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "norway");
                editor.commit();
            }
        });
        spain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countrySelect();
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("Allname", "spain");
                editor.commit();
            }
        });
