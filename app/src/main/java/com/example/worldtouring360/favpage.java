...
public class favpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navbarmethod();
        TextView faviconText = (TextView) findViewById(R.id.favText);
        faviconText.setTextColor(Color.WHITE);
        ...
        View clearFav = findViewById(R.id.favClearBtn);
        if(isDark == true)
        {
        ...
        switch (favCn)
        {
            ...
            case ("norway"):
                ...
                break;
                default:
                    TextView poptitletext = (TextView) findViewById(R.id.poptitle);
                    TextView captitleText = (TextView) findViewById(R.id.captitle);
                    TextView lantitleText = (TextView) findViewById(R.id.lantitle);
                    TextView nofavTexthidden = (TextView) findViewById(R.id.nofavtext);
                    cnflag = (ImageView) findViewById(R.id.flag);
                    cntext = (TextView) findViewById(R.id.countryName);
                    cnInfotext = (TextView) findViewById(R.id.countryinfo);
                    cnpoptext = (TextView) findViewById(R.id.pop);
                    ...
                    nextimage = (ImageButton) findViewById(R.id.nextImage);
                    imagescroll = (ImageView) findViewById(R.id.imagescroller);
                    clearFav.setVisibility(View.INVISIBLE);
                    cnflag.setVisibility(View.INVISIBLE);
                    cntext.setVisibility(View.INVISIBLE);
                    cnInfotext.setVisibility(View.INVISIBLE);
                    cncaptext.setVisibility(View.INVISIBLE);
                    cnlantext.setVisibility(View.INVISIBLE);
                    cnpoptext.setVisibility(View.INVISIBLE);
                    nextimage.setVisibility(View.INVISIBLE);
                    imagescroll.setVisibility(View.INVISIBLE);
                    poptitletext.setVisibility(View.INVISIBLE);
                    captitleText.setVisibility(View.INVISIBLE);
                    lantitleText.setVisibility(View.INVISIBLE);
                    nofavTexthidden.setVisibility(View.VISIBLE);
        }
